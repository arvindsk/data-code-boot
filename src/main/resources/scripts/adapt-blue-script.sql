...
INSERT INTO adaptdb.medicine_list (medicine_id, name) VALUES (303, 'No prescribed medications');
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, image_link) VALUES (119, 1, 0, '2', null, 'text', 'Weight(kg)', 'left', 0, null, 'number', null, 15, 14, null, 0, null, null, 0, null, 1, 200, null, 0, null, null, null);
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, image_link) VALUES (93, 1, 1, '3.6', '{3.1} = ''yes'' and {3.3} = ''yes'' and {3.4} = ''yes''', 'checkbox', null, 'hidden', 3, null, null, null, 10, 13, null, 0, null, null, 0, null, 0, 0, '{3.5} contains ''No prescribed medications''', 0, null, null, null);
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, image_link) VALUES (99, 1, 1, '4.6', '{4.1} = ''yes'' and {4.3} = ''yes'' and {4.4} = ''yes''', 'checkbox', null, 'hidden', 3, null, null, null, 11, 13, null, 0, null, null, 0, null, 0, 0, '{4.5} contains ''No prescribed medications''', 0, null, null, null);
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, image_link) VALUES (105, 1, 1, '5.6', '{5.1} = ''yes'' and {5.3} = ''yes'' and {5.4} = ''yes''', 'checkbox', null, 'hidden', 3, null, null, null, 12, 13, null, 0, null, null, 0, null, 0, 0, '{5.5} contains ''No prescribed medications''', 0, null, null, null);
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, image_link) VALUES (111, 1, 1, '6.6', '{6.1} = ''yes'' and {6.3} = ''yes'' and {6.4} = ''yes''', 'checkbox', null, 'hidden', 3, null, null, null, 13, 13, null, 0, null, null, 0, null, 0, 0, '{6.5} contains ''No prescribed medications''', 0, null, null, null);
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, image_link) VALUES (117, 1, 1, '7.6', '{7.1} = ''yes'' and {7.3} = ''yes'' and {7.4} = ''yes''', 'checkbox', null, 'hidden', 3, null, null, null, 14, 13, null, 0, null, null, 0, null, 0, 0, '{7.5} contains ''No prescribed medications''', 0, null, null, null);
