...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, popupdescription, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, html, image_link, width) VALUES (86, 1, 0, '2.5', '{2.1} = ''yes'' and {2.3} = ''yes'' and {2.4} = ''yes''', 'tagbox', 'Elevated Blood Pressure Medication/supplements', 'left', 0, 'Please select the medications you believe to be taking for this condition', null, null, null, 9, 13, 'http://adaptboot-env.eba-ty3ytask.us-east-2.elasticbeanstalk.com/api/adapt/questionnaire/medicine', 0, null, 'select2', 0, null, 0, 0, null, 0, null, null, null, null, '100%');
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, popupdescription, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, html, image_link, width) VALUES (92, 1, 0, '3.5', '{3.1} = ''yes'' and {3.3} = ''yes'' and {3.4} = ''yes''', 'tagbox', 'Elevated cholesterol Medication/supplements', 'left', 0, 'please select the medications you believe to be taking for this condition', null, null, null, 10, 13, 'http://adaptboot-env.eba-ty3ytask.us-east-2.elasticbeanstalk.com/api/adapt/questionnaire/medicine', 0, null, 'select2', 0, null, 0, 0, null, 0, null, null, null, null, '100%');
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, popupdescription, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, html, image_link, width) VALUES (143, 1, 1, '4.1', '{4} = ''hotcereal''', 'tagbox', 'Please select the type of Hot Cereal', 'left', 0, null, null, 'Type of Other Hot Cereal(describe)', null, 26, 16, 'http://adaptboot-env.eba-ty3ytask.us-east-2.elasticbeanstalk.com/api/adapt/questionnaire/cerealList', 0, null, null, 0, null, 0, 0, null, 0, null, null, null, null, '100%');
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, popupdescription, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, html, image_link, width) VALUES (144, 1, 1, '4.2', '{4} = ''coldcereal''', 'tagbox', 'Please select the type of Cold Cereal', 'left', 0, null, null, 'Type of Other Cold Cereal(describe)', null, 26, 16, 'http://adaptboot-env.eba-ty3ytask.us-east-2.elasticbeanstalk.com/api/adapt/questionnaire/cerealList', 0, null, null, 0, null, 0, 0, null, 0, null, null, null, null, '100%');
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, popupdescription, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, html, image_link, width) VALUES (98, 1, 0, '4.5', '{4.1} = ''yes'' and {4.3} = ''yes'' and {4.4} = ''yes''', 'tagbox', 'Diabetes Mellitus Medication/supplements', 'left', 0, 'please select the medications you believe to be taking for this condition', null, null, null, 11, 13, 'http://adaptboot-env.eba-ty3ytask.us-east-2.elasticbeanstalk.com/api/adapt/questionnaire/medicine', 0, null, 'select2', 0, null, 0, 0, null, 0, null, null, null, null, '100%');
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, popupdescription, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, html, image_link, width) VALUES (104, 1, 0, '5.5', '{5.1} = ''yes'' and {5.3} = ''yes'' and {5.4} = ''yes''', 'tagbox', 'Kidney Medication/supplements', 'left', 0, 'Please select the medications you believe to be taking for this condition', null, null, null, 12, 13, 'http://adaptboot-env.eba-ty3ytask.us-east-2.elasticbeanstalk.com/api/adapt/questionnaire/medicine', 0, null, 'select2', 0, null, 0, 0, null, 0, null, null, null, null, '100%');
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, popupdescription, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, html, image_link, width) VALUES (110, 1, 0, '6.5', '{6.1} = ''yes'' and {6.3} = ''yes'' and {6.4} = ''yes''', 'tagbox', 'Heart Medication/supplements', 'left', 0, 'Please select the medications you believe to be taking for this condition', null, null, null, 13, 13, 'http://adaptboot-env.eba-ty3ytask.us-east-2.elasticbeanstalk.com/api/adapt/questionnaire/medicine', 0, null, 'select2', 0, null, 0, 0, null, 0, null, null, null, null, '100%');
...
INSERT INTO adaptdb.elements (elements_id, start_with_new_line, has_other, name, visible_if, type, title, title_location, col_count, description, input_type, other_text, popupdescription, page_id, questionnaires_id, choices_by_url, is_required, enable_if, render_as, is_all_row_required, default_value, min, max, required_if, indent, image_height, image_width, html, image_link, width) VALUES (116, 1, 0, '7.5', '{7.1} = ''yes'' and {7.3} = ''yes'' and {7.4} = ''yes''', 'tagbox', 'Vascular Medication/supplements', 'left', 0, 'please select the medications you believe to be taking for this condition', null, null, null, 14, 13, 'http://adaptboot-env.eba-ty3ytask.us-east-2.elasticbeanstalk.com/api/adapt/questionnaire/medicine', 0, null, 'select2', 0, null, 0, 0, null, 0, null, null, null, null, '100%');
