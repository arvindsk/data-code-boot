...
update adaptdb.elements set choices_by_url = 'http://localhost:8080/api/adapt/questionnaire/countList' where choices_by_url='http://localhost:8080/api/adapt/questionnaire/countList';
