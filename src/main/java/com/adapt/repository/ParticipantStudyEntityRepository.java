...
public interface ParticipantStudyEntityRepository extends JpaRepository<ParticipantStudyEntity, Integer>, JpaSpecificationExecutor<ParticipantStudyEntity> {
    ...
    List<ParticipantStudyEntity> findByStudyIdAndTimelineAndStatusAndParticipantIdIn(Integer studyId, String timeline, String status, List<Integer> participantIds);
    ...
    ParticipantStudyEntity findByQuid(String quid);
}
